About generalisedformanricci-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/generalisedformanricci-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11012&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/generalisedformanricci-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `generalisedformanricci` can be installed with `conda`:
...
```
mamba install generalisedformanricci
```

It is possible to list all of the versions of `generalisedformanricci` available on your platform with `conda`:
...
```
mamba search generalisedformanricci --channel conda-forge
```
...
mamba repoquery search generalisedformanricci --channel conda-forge

# List packages depending on `generalisedformanricci`:
mamba repoquery whoneeds generalisedformanricci --channel conda-forge

# List dependencies of `generalisedformanricci`:
mamba repoquery depends generalisedformanricci --channel conda-forge
```
